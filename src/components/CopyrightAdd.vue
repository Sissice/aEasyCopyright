<template>
  <div style="margin: 20px" >
    <el-form label-width="150px" :model="copyrightForm" label-position=top ref="Form">
  ...
  <template #tip>
      ...
      <el-select v-model="copyrightForm.category" placeholder="请选择你的作品类别" style="display: block;">
        ...
        <el-option label="工程设计图、产品设计图、地图、示意图等图形作品和模型作品" value="8" />
        <el-option label="计算机软件" value="9" />
      </el-select>
    </el-form-item>
    <el-form-item label="作品创作性质">
      <el-select v-model="copyrightForm.createType" placeholder="请选择你的作品创作性质" style="display: block;">
        <el-option label="无" value="0" />
    ...
    <el-form-item label="权利取得方式">
      <el-select v-model="copyrightForm.rightObtainType" placeholder="请选择你的权利取得方式" style="display: block;">
        <el-option label="无" value="0" />
        <el-option label="其他" value="1" />
    ...
    <el-form-item label="权利拥有方式">
      <el-select v-model="copyrightForm.rightOwnType" placeholder="请选择你的权利拥有方式" style="display: block;">
        <el-option label="无" value="0" />
    ...
    <el-form-item label="著作权人类型">
      <el-select v-model="copyrightForm.authorType" placeholder="请选择你的著作权人类型" style="display: block;">
        <el-option label="无" value="0" />
    ...
    <el-form-item label="版权局登记状态">
      <el-select v-model="copyrightForm.status" placeholder="请选择你的版权局登记状态" style="display: block;">
        <el-option label="无" value="0" />
        <el-option label="其他" value="1" />
    ...
    <el-form-item label="登记版权局">
        <el-input id="copyrightOffice" v-model="copyrightForm.copyrightOffice"/>
    </el-form-item>
    <el-form-item label="链上存证有效状态">
      <el-select v-model="copyrightForm.isStatus" placeholder="请选择你的链上存证有效状态" style="display: block;">
        <el-option label="无" value="0" />
...
export default {
  ...
  data() {
    return {
      thekey: '', //2c4ebce01658995826327357
      copyrightdata:["123123","a","1245",2,1,1,1,1,"Alice",'0x086816ED0dF2B68e292fcD67B852dd97B92f059D',1,"http",1,"office",1,"more"],
      uid:'2c4ebce0',
      thesign:'0xcf91b07f7a9a0b623d8fbebe0ac8ebcabd543b180fc2502d8af5a98001bcb0997bb60958d987e89fdd0d08392f6d1f2b2276d1cef8b5f82df2c47ec3b02d0a331b',
      txReceipt:[],
      copyrightForm: {
      name: 'test',
      dataFinger: '1',
...
//         console.log(err);
//     }
  // copyright.methods.copyrightAdd(this.copyrightdata,this.uid,this.thesign).send({ from: ethereum.selectedAddress });
  // const copyrightQuery = await copyright.methods.copyrightQuery(this.uid).call()
  // console.log('query =', copyrightQuery)
  

  const signdata = await copyright.methods.getTheSigndata(this.copyrightData).call()
...
// .then(console.log);
// web3.eth.accounts.wallet.add('ce4bd15a4c479a148c701b6e4019f39b23bf90b9803ef8d441e691f66ce0ae05')
...
//                 console.log(web3.eth.defaultAccount)
  ...
  const transactionParameters = {
    from: ethereum.selectedAddress,
    to: contractAddress,
    data: copyright.methods.copyrightAdd(this.copyrightData,this.uid,this.thesign).encodeABI(),
    // chainId: '0x80001',
    gas: '0x6ddd0',
    value: '0x0' 
...
//       web3 = new Web3(new Web3.providers.HttpProvider("https://matic-mumbai.chainstacklabs.com"));//这里填写你的ganache-cli/ganache监听地址
//     }
